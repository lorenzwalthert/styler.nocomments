...
The goal of {styler.nocomments} is to remove all comments, nothing more and 
nothing less. It is a third-party 
style guide for [{styler}](https://styler.r-lib.org).


## Installation

You can install the released version of {styler.nocomments} from [GitHub](https://github.com) with:
