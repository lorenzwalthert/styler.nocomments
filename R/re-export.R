...
#' Like [styler::style_dir()], but `style` defaulting to `nocomments_style`
#'
...
#' Like [styler::style_file()], but `style` defaulting to `nocomments_style`
#'
...
#' Like [styler::style_pkg()], but `style` defaulting to `nocomments_style`
#'
...
#' Like [styler::style_text()], but `style` defaulting to `nocomments_style`
#'
